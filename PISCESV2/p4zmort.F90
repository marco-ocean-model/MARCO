...
CONTAINS
   ...
   SUBROUTINE p4z_mort_nano( Kbb, Krhs )
      ...
      !$OMP SHARED(tr, xlimphy, wchln, xstep, xdiss, mpratn, xkmort, &
                   rtrn, xfracal, prodcal, prodpoc, zp, zfactfe, zfactch)
      DO_3D( 0, 0, 0, 0, 1, jpkm1)
         ...
         prodcal(ji,jj,jk) = prodcal(ji,jj,jk) + zprcaca
   ...
   SUBROUTINE p4z_mort_diat( Kbb, Krhs )
      ...
      !$OMP PARALLEL DO &
      !$OMP PRIVATE(ji, jj, jk) &
      !$OMP SHARED(tr, xlimdia, wchld, xstep, xdiss, mpratd, rtrn, &
      ...
      DO_3D( 0, 0, 0, 0, 1, jpkm1)
         ...
         zrespp2 = 1.e6 * xstep * wchld * zlim1 * xdiss(ji,jj,jk) &
                 * zcompadi * tr(ji,jj,jk,jpdia,Kbb)

...
!$acc end kernels
      ...
      subroutine exchange_r2d_1pts_tile (Istr,Iend,Jstr,Jend, A)
      implicit none
      integer*4  LLm,Lm,MMm,Mm,N, LLm0,MMm0
      parameter (LLm0=41,   MMm0=42,   N=32)
      parameter (LLm=LLm0,  MMm=MMm0)
...
!$acc end kernels
      ...
      subroutine exchange_u2d_1pts_tile (Istr,Iend,Jstr,Jend, A)
      implicit none
      integer*4  LLm,Lm,MMm,Mm,N, LLm0,MMm0
      parameter (LLm0=41,   MMm0=42,   N=32)
      parameter (LLm=LLm0,  MMm=MMm0)
...
!$acc end kernels
      ...
      subroutine exchange_v2d_1pts_tile (Istr,Iend,Jstr,Jend, A)
      implicit none
      integer*4  LLm,Lm,MMm,Mm,N, LLm0,MMm0
      parameter (LLm0=41,   MMm0=42,   N=32)
      parameter (LLm=LLm0,  MMm=MMm0)
...
!$acc end kernels
      ...
      subroutine exchange_p2d_1pts_tile (Istr,Iend,Jstr,Jend, A)
      implicit none
      integer*4  LLm,Lm,MMm,Mm,N, LLm0,MMm0
      parameter (LLm0=41,   MMm0=42,   N=32)
      parameter (LLm=LLm0,  MMm=MMm0)

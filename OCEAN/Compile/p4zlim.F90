...
CONTAINS
   ...
   SUBROUTINE p4z_lim( kt, knt, Kbb, Kmm )
      ...
      !
      !$OMP PARALLEL DO &
      !$OMP PRIVATE(ji, jj, jk, z1_trbphy, z1_trbdia, concnfe, zconc0n, zconc0nnh4, &
      ...
      ! --------------------------------------------------------------------
      !$OMP PARALLEL DO &
      !$OMP PRIVATE(ji, jj, jk, zlim1, zlim2, zlim3, ztem1, ztem2, zetot1, zetot2) &
      !$OMP SHARED(tr, jppo4, jpfer, jp_tem, Kbb, Kmm, xnanonh4, xnanono3, &
                   concnnh4, etot_ndcy, caco3r, xsizephy, hmld, rtrn, xfracal)
      DO_3D( 0, 0, 0, 0, 1, jpkm1)
